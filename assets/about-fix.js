(function () {
    ...
    const NEW_CONTENT_HTML = `
        <div class="about-fixed-content space-y-4 text-justify" dir="rtl">
            ...
            <p>
                עו"ד שמעון - טואטי השלימה את לימודיה לתואר במשפטים בשנת 2008 במסגרת תוכנית מצטייני רקטור עם מלגת מצוינות, וסיימה אותו במקום הראשון מתוך כ- 120 בוגרים.
            </p>
            <p>
            ...
            <p>
                המשרד מייצג לקוחות הן במחלוקות משפטיות והן בליווי עסקאות ויוזמות חיוביות – כגון רכישה ומכירה של דירות ועסקים, הקמת חברות, ניסוח וחתימה על חוזים מסחריים והסכמים בין מייסדים, בעלי מניות ושותפים.
            </p>
            <p>
